...
class MainWindow(QMainWindow):
    ...
    def dialog(self):
        ...
        dlg.setText("Impossible de se connecter ou connexion reset")
    ...
    def dialog(self):
        dlg = QMessageBox(self)
        dlg.setWindowTitle("Erreur")
        dlg.setText("L'addition n'est pas possible car la valeur n'est pas correcte.")
        dlg.setStandardButtons(QMessageBox.Ok)
        dlg.setIcon(QMessageBox.Question)
        dlg.exec()
